...
router.put("/:id", authenticate, isValidId, validation(joiSchema), ctrlWrapper(ctrl.updateById));
router.patch("/:id/favorite", authenticate, isValidId, validation(favoriteJoiSchema), ctrlWrapper(ctrl.updateFavorite));
